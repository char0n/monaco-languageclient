...
const MODEL_URI = 'inmemory://vscodeDocument.json'
...
// const codeConverter = new MonacoToProtocolConverter(monaco);
// const protocolConverter = new ProtocolToMonacoConverter(monaco);
...
function validate(): void {
    console.log(vscode.workspace.textDocuments.map(d => d.uri.toString()), MODEL_URI)
    const document = createDocument(vscodeDocument);
